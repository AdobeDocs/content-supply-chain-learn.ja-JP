---
title: コンテンツ作成および実稼動チュートリアル
description: 強力なジェネレーティブ AI と、Creative Cloudと統合されたシームレスなコラボレーション ツールにより、アイデアを創出し、創造を加速します。 Adobeは、業界をリードするクリエイティブテクノロジーと画期的な AI を組み合わせて、クリエイティビティを発揮し、生産を拡大し、クリエイティブの品質を維持します。
...
# コンテンツ作成および実稼動チュートリアル

強力なジェネレーティブ AI と、Creative Cloudと統合されたシームレスなコラボレーション ツールにより、アイデアを創出し、創造を加速します。 Adobeは、業界をリードするクリエイティブテクノロジーと画期的な AI を組み合わせて、クリエイティビティを発揮し、生産を拡大し、クリエイティブの品質を維持します。

コンテンツ作成に使用されるAdobeソリューション：
...
<div class="columns is-multiline">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.corp.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html" title="Fireflyの使用例">Fireflyの活用例 </a>
          </p>
          <p class="is-size-6">Fireflyを使用して、感動的な PowerPoint プレゼンテーション、ムード ボード、アイデア、スクリーンセーバーなどを作成する方法を説明します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Generative recolor" tabIndex="1">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html" title="生成色" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427610?format=jpeg" alt="生成色">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html" title="生成色"> 生成色 </a>
          </p>
          <p class="is-size-6">商品のパッケージ、ポスター、ベクターファイルのアートワークに対する様々なカラーバリエーションを即座にプレビューする方法を説明します。 ジェネレーティブリカラーを使用すると、入力できるだけすばやく再配色できます。 既成のアイデアを試し、様々なテーマやパレットを中心にアイデアを生み出し、すばやく複数のバリエーションを作成します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Generative fill" tabIndex="2">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html" title="ジェネレーティブフィル" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427609?format=jpeg" alt="ジェネレーティブフィル">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html" title="ジェネレーティブフィル"> ジェネレーティブフィル </a>
          </p>
          <p class="is-size-6">ジェネレーティブフィルを使用して、簡単なテキストプロンプトで画像のコンテンツを非破壊的に追加、展開、削除する方法を説明します。 ジェネレーティブフィルを使用すると、創造性を高め、並外れたプロジェクトを作成できます。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">説明テキストから画像を作成する方法を説明します。 具体的なニーズに応じて画像を生成することで、パーソナライズされた感動的なコンテンツを作成できます。</p>
        </div>
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
          <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細を表示 </span>
        </a>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe Fireflyの使用を開始する方法については、firefly.adobe.comを参照してください。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Discover Adobe Firefly" tabIndex="5">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html" title="Discover のAdobe Firefly" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427606?format=jpeg" alt="Discover のAdobe Firefly">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html" title="Discover のAdobe Firefly">Discover Adobe Firefly</a>
          </p>
          <p class="is-size-6">商用の安全使用とイノベーションのために設計されたジェネレーティブ AI で、Adobe Fireflyにクリエイティビティの未来を見つけましょう。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create digital screen announcements for the office" tabIndex="6">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-digital-screens.html" title="オフィスのデジタル画面のお知らせの作成" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427119?format=jpeg" alt="オフィスのデジタル画面のお知らせの作成">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-digital-screens.html" title="オフィスのデジタル画面のお知らせの作成"> オフィスのデジタル画面のお知らせの作成 </a>
          </p>
          <p class="is-size-6">オフィス向けの魅力的なデジタル画面のお知らせを作成する方法を説明します。 Adobe Fireflyを活用したテキストからテンプレートへの変換を使用すると、テキストコピー用のスペースを使用してパーソナライズされた画像を生成できます。 生成フィルとアニメーションが追加され、アナウンスの魅力が高まります。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">PowerPoint プレゼンテーションの魅力的な背景を作成する方法を説明します。 Adobe Fireflyを活用したテキストから画像への変換を使用すると、プレゼンテーション用にパーソナライズされた画像を生成し、さらに画像に変更を加えて効果を加え、プレゼンテーションで使用するためにダウンロードすることができます。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Update finance roun" tabIndex="8">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/update-image.html" title="財務ルートの更新" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427116?format=jpeg" alt="財務ルートの更新">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/update-image.html" title="財務ルートの更新"> 財務ルートの更新 </a>
          </p>
          <p class="is-size-6">ジェネレーティブフィルを使用して要素を置き換え、書体と色を一致させてテキストを変更し、新しい画像の背景を削除することで、静的なグラフィック画像をすばやく更新します。 これは、金融切り上げなどのグラフィックアセットの再利用を迅速かつ簡単に行う方法です。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="How to use Text-to-template Gen AI" tabIndex="9">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/text-to-template.html" title="テキストからテンプレートへの生成 AI の使用方法" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427022?format=jpeg" alt="テキストからテンプレートへの生成 AI の使用方法">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/text-to-template.html" title="テキストからテンプレートへの生成 AI の使用方法"> テキストからテンプレートへの生成 AI の使用方法 </a>
          </p>
          <p class="is-size-6">テキストの説明からソーシャル投稿、ポスター、チラシ、カード用の編集可能なテンプレートを数秒で生成する方法を説明します。 ダウンロードや共有を行う前に、デザインの編集、フォントの変更、プロジェクトのブランディングを行うことができます。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Improving your text design with Gen AI" tabIndex="10">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/gen-text.html" title="Gen AI によるテキストデザインの改善">Gen AI によるテキストデザインの向上 </a>
          </p>
          <p class="is-size-6">Adobe Fireflyを活用したテキスト効果を使用して、効果的なデザインを作成する方法を説明します。 テキストプロンプトを使用して、洗練や装飾が可能な特別なテキスト効果を生成できます。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="How to use Generative Fill" tabIndex="11">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/generative-fill.html" title="ジェネレーティブフィルの使用方法" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427020?format=jpeg" alt="ジェネレーティブフィルの使用方法">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/generative-fill.html" title="ジェネレーティブフィルの使用方法"> ジェネレーティブフィルの使用方法 </a>
          </p>
          <p class="is-size-6">Adobe Fireflyを活用したジェネレーティブフィルを使用して、画像に要素を追加および画像から要素を削除する方法を説明します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="What are the new Gen AI features in Adobe Express?" tabIndex="12">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/intro-gen-ai.html" title="Adobe Expressの新しい Gen AI の機能は何ですか？" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3427018?format=jpeg" alt="Adobe Expressの新しい Gen AI の機能は何ですか？">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/intro-gen-ai.html" title="Adobe Expressの新しい Gen AI の機能は何ですか？">Adobe Expressにおける Gen AI の新機能は何ですか？</a>
          </p>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe Fireflyを活用したジェネレーティブ AI 画像をクリエイティブプロジェクトに追加する方法を説明します。 </p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe Expressに統合された使いやすいデザインツールを使用して、プロフェッショナルな外観のPDFを作成する方法を説明します。†</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe PhotoshopとIllustratorで、AI を活用したジェネレーティブ ツールを使用して、コンテンツの作成を高速化する方法について説明します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Adobe Express integration" tabIndex="17">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-express-aem-assets-add-on.html" title="Adobe Express の統合">Adobe Expressの統合 </a>
          </p>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">コマースチームがオンラインストアに新しい在庫セットのための魅力的な画像を簡単に作成する方法を説明します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">分散型フィールドマーケティングチームがローカルマーケティングキャンペーン用に地域に合わせてコンテンツを簡単にカスタマイズする方法を説明します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Jumpstart creative ideation" tabIndex="20">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/jumpstart-ideation.html" title="クリエイティブなアイデアをすぐに生み出す" tabindex="-1">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/jumpstart-ideation.html" title="クリエイティブなアイデアをすぐに生み出す">Jumpstart のクリエイティブなアイデア </a>
          </p>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create flyer content for marketing campaign with Firefly" tabIndex="21">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-local-marketing.html" title="Fireflyを使用したマーケティングキャンペーン用のチラシのコンテンツの作成" tabindex="-1">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-local-marketing.html" title="Fireflyを使用したマーケティングキャンペーン用のチラシのコンテンツの作成">Fireflyを使用したマーケティングキャンペーン用のチラシ用コンテンツの作成 </a>
          </p>
          <p class="is-size-6">Adobe Expressで、Adobe Fireflyを活用したテキストから画像への変換を使用して、グローバルなホテルマーケティングキャンペーンからローカライズされたコンテンツを作成する方法を説明します。†</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe Fireflyを活用してテキストから画像を生成する方法を、従業員の採用やオンボーディングコンテンツ用に独自のグラフィックを作成するAdobe Expressで説明します。 この例では、会社内のすべてのユーザーが正確にブランドに合わせたコンテンツを作成できるように、テンプレートを使用します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe Fireflyを活用したテキストから画像への変換を使用して、web、ブログ、ソーシャルキャンペーン用に独自のグラフィックコンテンツを作成する方法を説明します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe IllustratorでAdobe Fireflyを活用したジェネレーティブリカラーを使用して、カスタムホテルのティーボックスのベクターイメージをすばやく再配色する方法を説明します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">シンプルなテキストプロンプトを使用して、プロジェクトに一意の感動的なテキストを作成する方法を説明します。 テキストエフェクトを使用すると、創造性を高め、プロジェクトに特別なテキストを作成できます。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create webinar posters with Firefly" tabIndex="26">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-webinar-poster.html" title="Fireflyを使用したウェビナーポスターの作成" tabindex="-1">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-webinar-poster.html" title="Fireflyを使用したウェビナーポスターの作成">Fireflyを使用したウェビナーポスターの作成 </a>
          </p>
          <p class="is-size-6">Adobe Fireflyを活用したテキストを画像やテキスト効果に使用し、バーチャル VR イベント用のソーシャルメディアのポスターを作成するAdobe Expressを学びます。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Adobe PhotoshopでAdobe Fireflyを活用したジェネレーティブフィルを使用して、web 広告バナーの作成を高速化する方法を説明します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">トラベル広告のコンセプトを簡単に作成できるように、Adobe PhotoshopでAdobe Fireflyを活用したジェネレーティブフィルを使用する方法を説明します。†</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Creating social posters with Firefly" tabIndex="29">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-social-posters.html" title="Fireflyを使用したソーシャルポスターの作成" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3420533?format=jpeg" alt="Fireflyを使用したソーシャルポスターの作成">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-social-posters.html" title="Fireflyを使用したソーシャルポスターの作成">Fireflyでソーシャルなポスターを作る </a>
          </p>
          <p class="is-size-6">Adobe Fireflyを活用したテキストを画像やテキスト効果に使用し、Adobe Expressでソーシャルメディアのプロモーションキャンペーンを作成する方法を説明します。</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Use CC Libraries" tabIndex="30">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/cc-libraries.html" title="CC Librariesの使用" tabindex="-1">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/cc-libraries.html" title="CC Librariesの使用">CC Librariesの使用 </a>
          </p>
      ...
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/videooverview/videotutorials/video-review-frame-io.html" title="Frame.io のビデオレビュー" tabindex="-1">
            <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/assets/Videoreviewwithframe.png" alt="Frame.io のビデオレビュー">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">この実践チュートリアルでは、Adobe Premiere Proの Frame.io 拡張機能を使用して、アセットを一元管理して共有し、リアルタイムのコメントを受け取り、修正を追跡し‚迅速な承認を得る方法を説明します。</p>
        </div>
    ...
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      ...
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          ...
          <p class="is-size-6">Assets EssentialsをAdobe Creative Cloud ライブラリと統合する方法を学ぶ</p>
        </div>
  ...
  <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="AEM Desktop App 2.0" tabIndex="36">
    <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
      <div class="card-image">
        <figure class="image x-is-16by9">
          <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app.html?lang=ja" title="AEM デスクトップアプリケーション 2.0" tabindex="-1">
            <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/28868?format=jpeg" alt="AEM デスクトップアプリケーション 2.0">
          </a>
        </figure>
      </div>
      <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
        <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
            <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app.html?lang=ja" title="AEM デスクトップアプリケーション 2.0">AEM デスクトップアプリ 2.0</a>
          </p>
